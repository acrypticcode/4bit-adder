...
HD_PWD='C:/Users/curra/OneDrive/MyFiles/@RPI/CoCO/Vivado_Projects/studio3/studio3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel.vds -m64 -mode batch -messageDb vivado.pb -notrace -source toplevel.tcl
